package com.zhilian.common.constants;
...
public interface MqConstants {
    ...
    interface Exchanges {
         ...
         * 交易（支付）
         */
        String TRADE = "zhilian.exchange.topic.trade";
    ...
    interface Queues {
         ...
         * 订单微服务：更新支付状态
         */
        String ORDERS_TRADE_UPDATE_STATUS = "zhilian.queue.orders.trade.update.Status";

        /**
         * 订单微服务：更新支付状态
         */
        String SCORE_STATISTICS = "zhilian.queue.customer.score.statistics";
    }
