...
import com.zhilian.api.orders.dto.response.OrderResDTO;
import com.zhilian.api.orders.dto.response.OrderSimpleResDTO;
import com.zhilian.api.trade.NativePayApi;
import com.zhilian.api.trade.TradingApi;
import com.zhilian.api.trade.dto.request.NativePayReqDTO;
...
import com.zhilian.orders.manager.model.dto.request.PlaceOrderReqDTO;
...
import static com.zhilian.orders.base.constants.RedisConstants.Lock.ORDERS_SHARD_KEY_ID_GENERATOR;
import static com.zhilian.orders.base.constants.RedisConstants.RedisKey.ORDERS;
import static com.zhilian.orders.base.constants.RedisConstants.Ttl.ORDERS_PAGE_TTL;
...
public class OrdersCreateServiceImpl extends ServiceImpl<OrdersMapper, Orders> implements IOrdersCreateService {
    ...
    private NativePayResDTO generatQrCode(Orders orders, PayChannelEnum tradingChannel) {
        ...
        nativePayReqDTO.setProductAppId(PRODUCT_APP_ID);//指定支付来源是订单
        //判断是否切换支付渠道
